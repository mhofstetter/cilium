...
func newDaemon(ctx context.Context, cleaner *daemonCleanup, params *daemonParams) (*Daemon, *endpointRestoreState, error) {
	...
	lbmap.Init(lbInitParamsFromConfig())
	...
	if option.Config.DNSPolicyUnloadOnShutdown {
		...
		cleaner.preCleanupFuncs.Add(d.k8sWatcher.StopK8sServiceHandler)
		cleaner.preCleanupFuncs.Add(d.cleanupDNS)
	}
...
func lbInitParamsFromConfig() lbmap.InitParams {
