...
func TestCheckMapSizeLimits(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			want: sizes{
				CTMapEntriesGlobalTCP: 3926403, // calculated
				CTMapEntriesGlobalAny: 1963201, // calculated
				NATMapEntriesGlobal:   3926403, // calculated
				NeighMapEntriesGlobal: 3926403, // calculated
				AuthMapEntries:        1 << 19,
		...
		},
		{
			...
			want: sizes{
				...
				NATMapEntriesGlobal:   175444,
				NeighMapEntriesGlobal: 175444,
				WantErr:               true,
			},
		},
		{
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			require.NoError(t, tt.c.calculateBPFMapSizes())
