...
// signature.
func CiliumSlimEndpointResource(lc hive.Lifecycle, cs client.Clientset, _ *node.LocalNodeStore, opts ...func(*metav1.ListOptions)) (resource.Resource[*types.CiliumEndpoint], error) {
	if !cs.IsEnabled() {
		return nil, nil
	}
	lw := utils.ListerWatcherWithModifiers(
...
func CiliumEnvoyConfigResource(lc hive.Lifecycle, cs client.Clientset, opts ...func(*metav1.ListOptions)) (resource.Resource[*cilium_api_v2.CiliumEnvoyConfig], error) {
	...
	return resource.New[*cilium_api_v2.CiliumEnvoyConfig](lc, lw,
		resource.WithMetric("CiliumEnvoyConfig"),
	), nil
}
...
func CiliumClusterwideEnvoyConfigResource(lc hive.Lifecycle, cs client.Clientset, opts ...func(*metav1.ListOptions)) (resource.Resource[*cilium_api_v2.CiliumClusterwideEnvoyConfig], error) {
	...
	return resource.New[*cilium_api_v2.CiliumClusterwideEnvoyConfig](lc, lw,
		resource.WithMetric("CiliumClusterwideEnvoyConfig"),
	), nil
}
