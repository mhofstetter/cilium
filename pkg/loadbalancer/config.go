...
func NewConfig(log *slog.Logger, userConfig UserConfig, deprecatedConfig DeprecatedConfig, bpfMapsSizeConfig mapsize.BPFMapsSizeConfig) (cfg Config, err error) {
	...
	if cfg.LBSockRevNatEntries == 0 {
		getEntries := bpfMapsSizeConfig.GetDynamicSizeCalculator()
		cfg.LBSockRevNatEntries = getEntries(mapsize.SockRevNATMapEntriesDefault, mapsize.LimitTableAutoSockRevNatMin, mapsize.LimitTableMax)
