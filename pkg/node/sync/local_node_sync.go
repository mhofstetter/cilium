...
func (ini *localNodeSynchronizer) syncFromK8s(ln, new *node.LocalNode) {
	...
	ini.Logger.Debug("Syncing local node with new labels",
	...
	ini.Logger.Debug("Local node labels updated",
		logfields.Labels, logfields.Repr(ln.Labels),
	)

	ini.Logger.Debug("Syncing local node with new annotations",
	...
	ini.Logger.Debug("Local node annotations updated",
		logfields.Annotations, logfields.Repr(ln.Annotations),
	)
	...
	ini.Logger.Debug("Local node UID and ProviderID updated",
		"UID", ln.UID,
