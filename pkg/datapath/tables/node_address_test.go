...
// WaitForNodeIPAMAllocationCIDR implements node.LocalNodeSynchronizer.
func (t testLocalNodeSync) WaitForNodeIPAMAllocationCIDR(context.Context, *node.LocalNodeStore) error {
	return nil
}
