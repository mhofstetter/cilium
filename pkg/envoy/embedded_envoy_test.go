...
func (p *proxyAccessLoggerMock) NewLogRecord(t accesslogTypes.FlowType, ingress bool, tags ...accesslog.LogTag) *accesslogTypes.LogRecord {
	panic("unimplemented")
}

func (p *proxyAccessLoggerMock) Log(lr *accesslogTypes.LogRecord) {}
