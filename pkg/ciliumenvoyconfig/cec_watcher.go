...
func (r *ciliumEnvoyConfigWatcher) handleCECEvent(ctx context.Context, event resource.Event[*ciliumv2.CiliumEnvoyConfig]) error {
	...
	case resource.Upsert:
		event.Done(r.cecUpserted(ctx, event.Key, event.Object))
	case resource.Delete:
		event.Done(r.cecDeleted(ctx, event.Key))
	case resource.Sync:
		event.Done(nil)
	}
...
func (r *ciliumEnvoyConfigWatcher) handleCCECEvent(ctx context.Context, event resource.Event[*ciliumv2.CiliumClusterwideEnvoyConfig]) error {
	switch event.Kind {
	case resource.Upsert:
		event.Done(r.ccecUpserted(ctx, event.Key, event.Object))
	case resource.Delete:
		event.Done(r.ccecDeleted(ctx, event.Key))
	case resource.Sync:
		event.Done(nil)
	}
...
func (r *ciliumEnvoyConfigWatcher) cecUpserted(ctx context.Context, key resource.Key, cec *ciliumv2.CiliumEnvoyConfig) error {
	...
	if exists {
		return r.updateCiliumEnvoyConfig(appliedCEC.TypeMeta, appliedCEC.ObjectMeta, appliedCEC.Spec, cec.TypeMeta, cec.ObjectMeta, cec.Spec)
	}

	if err := r.addCiliumEnvoyConfig(cec.TypeMeta, cec.ObjectMeta, cec.Spec); err != nil {
		return err
	}
...
func (r *ciliumEnvoyConfigWatcher) cecDeleted(ctx context.Context, key resource.Key) error {
	...
	appliedCEC, exists := r.appliedCECs[key]
	if !exists {
		return fmt.Errorf("key %q doesn't exist", key)
	}

	if err := r.deleteCiliumEnvoyConfig(appliedCEC.TypeMeta, appliedCEC.ObjectMeta, appliedCEC.Spec); err != nil {
		return err
	}
...
func (r *ciliumEnvoyConfigWatcher) ccecUpserted(ctx context.Context, key resource.Key, ccec *ciliumv2.CiliumClusterwideEnvoyConfig) error {
	...
	if exists {
		return r.updateCiliumEnvoyConfig(appliedCCEC.TypeMeta, appliedCCEC.ObjectMeta, appliedCCEC.Spec, ccec.TypeMeta, ccec.ObjectMeta, ccec.Spec)
	}

	if err := r.addCiliumEnvoyConfig(ccec.TypeMeta, ccec.ObjectMeta, ccec.Spec); err != nil {
		return err
	}
...
func (r *ciliumEnvoyConfigWatcher) ccecDeleted(ctx context.Context, key resource.Key) error {
	...
	if err := r.deleteCiliumEnvoyConfig(appliedCCEC.TypeMeta, appliedCCEC.ObjectMeta, appliedCCEC.Spec); err != nil {
		return err
	}
...
func (r *ciliumEnvoyConfigWatcher) addCiliumEnvoyConfig(cecTypeMeta metav1.TypeMeta, cecObjectMeta metav1.ObjectMeta, cecSpec ciliumv2.CiliumEnvoyConfigSpec) error {
	scopedLog := r.logger.WithFields(logrus.Fields{
		logfields.CiliumEnvoyConfigName: cecObjectMeta.Name,
		logfields.K8sNamespace:          cecObjectMeta.Namespace,
		logfields.K8sUID:                cecObjectMeta.UID,
		logfields.K8sAPIVersion:         cecTypeMeta.APIVersion,
	})
...
func (r *ciliumEnvoyConfigWatcher) updateCiliumEnvoyConfig(
	oldCECTypeMeta metav1.TypeMeta, oldCECObjectMeta metav1.ObjectMeta, oldCECSpec ciliumv2.CiliumEnvoyConfigSpec,
	newCECTypeMeta metav1.TypeMeta, newCECObjectMeta metav1.ObjectMeta, newCECSpec ciliumv2.CiliumEnvoyConfigSpec,
) error {
	scopedLog := r.logger.WithFields(logrus.Fields{
		logfields.CiliumEnvoyConfigName: newCECObjectMeta.Name,
		logfields.K8sNamespace:          newCECObjectMeta.Namespace,
		logfields.K8sUID:                newCECObjectMeta.UID,
		logfields.K8sAPIVersion:         newCECTypeMeta.APIVersion,
	})
...
func (r *ciliumEnvoyConfigWatcher) deleteCiliumEnvoyConfig(cecTypeMeta metav1.TypeMeta, cecObjectMeta metav1.ObjectMeta, cecSpec ciliumv2.CiliumEnvoyConfigSpec) error {
	scopedLog := r.logger.WithFields(logrus.Fields{
		logfields.CiliumEnvoyConfigName: cecObjectMeta.Name,
		logfields.K8sNamespace:          cecObjectMeta.Namespace,
		logfields.K8sUID:                cecObjectMeta.UID,
